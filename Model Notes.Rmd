...
Start with no variables. Test the P possible variables and add the one which improves RSS (or R^2) by the most. Then test the P-1 remaining variables to see which one improves RSS the most. Repeast until all variables have been added. 
